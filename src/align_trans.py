...
def warp_and_crop_face(src_img,
    ...
    # print("source point",src_pts[0])
    # print("source point shape",src_pts[0].shape)
    src_pts_shp = src_pts[0].shape
    ...
    # print(src_pts[0][0:3])
    # print(ref_pts[0:3])
    if src_pts[0].shape != ref_pts.shape:
        raise FaceWarpException(
            'facial_pts and reference_pts must have the same shape')

    if align_type is 'cv2_affine':
        tfm = cv2.getAffineTransform(src_pts[0][0:3], ref_pts[0:3])
