...
def prepare_facebank(cfg, model):
    ...
    np.save(os.path.join('data', '/home/cspd/Documents/face_recognition/facebank.npy'), embeddings)
    np.save(os.path.join('data', '/home/cspd/Documents/face_recognition/names.npy'), names)
